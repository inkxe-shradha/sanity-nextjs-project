...
import { ORDER_BY_ID_QUERY } from '@/sanity/queries/orders.query';
import { auth } from '@clerk/nextjs/server';
import { ArrowLeft, Badge, CreditCard, MapPin } from 'lucide-react';
...
export default async function OrderDetailsPage({ params }: OrderPageProps) {
  ...
  const { data: order }: { data: ORDER_BY_ID_QUERYResult | null } =
    await sanityFetch({

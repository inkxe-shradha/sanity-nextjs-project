...
import {
  ...
  TOP_SOLD_PRODUCTS_QUERY,
  PRODUCT_INVENTORY_ANALYTICS_QUERY,
  UNFULFILLED_ORDERS_QUERY,
  REVENUE_COMPARISON_QUERY,
} from '@/sanity/queries/status.quey';
...
export async function GET() {
  try {
    ...
    const [
      ...
      client.fetch<ProductSale[]>(TOP_SOLD_PRODUCTS_QUERY),
      client.fetch<Product[]>(PRODUCT_INVENTORY_ANALYTICS_QUERY),
      client.fetch<UnfulfilledOrder[]>(UNFULFILLED_ORDERS_QUERY),
      client.fetch<RevenuePeriod>(REVENUE_COMPARISON_QUERY, {

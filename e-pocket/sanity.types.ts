...
// Source: ./sanity/queries/categories.query.ts
...
// Source: ./sanity/queries/customer.query.ts
// Variable: CUSTOMERS_BY_EMAIL_QUERY
// Query: *[_type == "customer" && email == $email][0] {  _id,  name,  clerkUserId,  stripeCustomerId,  email,  createdAt,}
export type CUSTOMERS_BY_EMAIL_QUERYResult = {
  _id: string;
  name: string | null;
...
// Variable: CUSTOMERS_BY_STRIPE_ID_QUERY
// Query: *[_type == "customer" && stripeCustomerId == $stripeCustomerId][0] {    _id,    name,    clerkUserId,    stripeCustomerId,    email,    createdAt,}
export type CUSTOMERS_BY_STRIPE_ID_QUERYResult = {
  _id: string;
  name: string | null;
  clerkUserId: string | null;
  stripeCustomerId: string | null;
...
export type ORDERS_BY_CLERK_USER_ID_QUERYResult = Array<{
  _id: string;
...
// Query: *[_type == "order" && _id == $id][0] {  _id,    orderNumber,    clerkUserId,    email,    items[] {    _key,    quantity,    priceAtPurchase,    product-> {      _id,      name,      "slug": slug.current,      "image": images[0] {        asset-> {            _id,            url        }      }    },    },    total,    status,    address {        name, line1, line2, city, state, postcode, country    },    createdAt,    stripePaymentId,}
...
// Variable: ORDER_EXISTS_BY_STRIPE_PAYMENT_ID_QUERY
// Query: *[_type == "order" && stripePaymentId == $stripePaymentId][0] {    _id}
export type ORDER_EXISTS_BY_STRIPE_PAYMENT_ID_QUERYResult = {
  _id: string;
} | null;
...
// Source: ./sanity/queries/status.quey.ts
// Variable: TOTAL_PRODUCTS_COUNT_QUERY
// Query: count(*[_type == "product"])
export type TOTAL_PRODUCTS_COUNT_QUERYResult = number;
// Variable: TOTAL_ORDERS_COUNT_QUERY
// Query: count(*[_type == "order"])
export type TOTAL_ORDERS_COUNT_QUERYResult = number;
...
// Variable: TOP_SOLD_PRODUCTS_QUERY
...
export type TOP_SOLD_PRODUCTS_QUERYResult = Array<{
  productId: string | null;
  productName: string | null;
  productPrice: number | null;
  quantity: number | null;
} | null>;
// Variable: PRODUCT_INVENTORY_ANALYTICS_QUERY
// Query: *[_type == "product"] {  _id,  name,  price,  stock,  "category": category->title}
export type PRODUCT_INVENTORY_ANALYTICS_QUERYResult = Array<{
  _id: string;
  name: string | null;
  price: number | null;
  stock: number | null;
...
// Variable: REVENUE_COMPARISON_QUERY
...
export type REVENUE_COMPARISON_QUERYResult = {
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    "*[_type == \"customer\" && email == $email][0] {\n  _id,\n  name,\n  clerkUserId,\n  stripeCustomerId,\n  email,\n  createdAt,\n}": CUSTOMERS_BY_EMAIL_QUERYResult;
    "*[_type == \"customer\" && stripeCustomerId == $stripeCustomerId][0] {\n    _id,\n    name,\n    clerkUserId,\n    stripeCustomerId,\n    email,\n    createdAt,\n}": CUSTOMERS_BY_STRIPE_ID_QUERYResult;
    ...
    "*[_type == \"order\" && stripePaymentId == $stripePaymentId][0] {\n    _id\n}": ORDER_EXISTS_BY_STRIPE_PAYMENT_ID_QUERYResult;
    ...
    "count(*[_type == \"product\"])": TOTAL_PRODUCTS_COUNT_QUERYResult;
    "count(*[_type == \"order\"])": TOTAL_ORDERS_COUNT_QUERYResult;
    "math::sum(*[_type == \"order\" && status in [\"paid\", \"shipped\", \"delivered\"]].total)": TOTAL_REVENUE_QUERYResult;

...
import { ORDERS_BY_CLERK_USER_ID_QUERYResult } from '@/sanity.types';
import { ORDERS_BY_CLERK_USER_ID_QUERY } from '@/sanity/queries/orders.query';
  ...
  return tool({
    ...
    execute: async ({ status }) => {
      ...
      try {
        ...
        let filteredOrders = orders as ORDERS_BY_CLERK_USER_ID_QUERYResult;
        if (status) {

    ...
    <div className="bg-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg md:text-xl text-violet-100 leading-relaxed">
                I'm a creative developer passionate about building beautiful, responsive, and user-friendly web experiences. Let's turn your ideas into reality.
              </p>
      ...
      <section className="py-12 md:py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <Slider images={sliderImages} autoPlay={true} autoPlayInterval={5000} />
        </div>
      </section>
      ...
      <section className="py-12 md:py-16 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Recent Works</h2>
          </div>
              ...
              >
                <div className="relative h-48 overflow-hidden bg-gray-200">
                  ...
                  <div className="absolute inset-0 bg-violet-600 bg-opacity-0 group-hover:bg-opacity-75 transition duration-300 flex items-center justify-center">
                    <Button variant="secondary" size="md" className="opacity-0 group-hover:opacity-100 transition duration-300">
                      View Details
                    </Button>
                  </div>
                </div>
                <div className="p-6">
                  <p className="text-violet-600 font-semibold text-sm mb-2">{project.category}</p>
